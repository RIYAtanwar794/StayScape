...
🔗 **Live Application:** https://stayscape-ghms.onrender.com
...
This project follows the MVC (Model–View–Controller) architecture to ensure modularity, scalability, maintainability, and separation of concerns.


## 🚀 Future Enhancements

- AI-powered price recommendation for hosts
- Nearby Places recommendation using Google Places API
